...
class PublishDocumentationsHandlerTest {
  ...
  public void setup() {
    ...
    setupTestcasesFromFiles(
        ...
        null,
        List.of(
            ImmutablePair.of("api-a.yaml", Optional.empty()),
            ImmutablePair.of("api-a.yaml", Optional.empty())));
  ...
  void shouldNotPerformCreateOrUpdateStageWhenDocVersionExistsAndItsAssociatedWithProdStage() {
    ...
    var listDocumentationVersionsResponse =
        GetDocumentationVersionsResponse.builder()
            .items(DocumentationVersion.builder().version(expectedVersion).build())
            .build();
        ...
        GetStagesResponse.builder()
            .item(
                List.of(
                    Stage.builder()
                        .stageName("Prod")
                        .documentationVersion(expectedVersion)
                        .build()))
            .build();
    ...
    verify(apiGatewayAsyncClient, never())
        .createDocumentationVersion(any(CreateDocumentationVersionRequest.class));
        ...
        GetDocumentationVersionsResponse.builder()
            .items(
                DocumentationVersion.builder()
                    .version(ApplicationConstants.VERSION_NAME + "-" + expectedHash)
                    .build())
            .build();
